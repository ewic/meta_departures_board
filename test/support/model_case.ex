defmodule MbtaDeparturesBoard.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import MbtaDeparturesBoard.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&MbtaDeparturesBoard.ErrorHelpers.translate_error/1)
